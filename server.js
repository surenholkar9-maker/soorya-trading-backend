...
const REDIRECT_URI = 'https://surenholkar9-maker.github.io/soorya-trading/callback.html';
...
app.post('/api/order', async (req, res) => {
    const { token, symbol, quantity, transaction_type, price } = req.body;
    try {
        const response = await axios.post('https://api.upstox.com/v2/order/place', {
            ...
            order_type: parseFloat(price) > 0 ? 'LIMIT' : 'MARKET',
